...
public interface BanqueService {
    ...
    @RequestWrapper(localName = "convertioneEuroToDH", targetNamespace = "http://ws/", className = "proxy.ConvertioneEuroToDH")
    @ResponseWrapper(localName = "convertioneEuroToDHResponse", targetNamespace = "http://ws/", className = "proxy.ConvertioneEuroToDHResponse")
    @Action(input = "http://ws/BanqueService/convertioneEuroToDHRequest", output = "http://ws/BanqueService/convertioneEuroToDHResponse")
    public double convertioneEuroToDH(
